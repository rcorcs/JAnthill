export CLASSPATH=./src/:./lib/jsch-0.1.50.jar:./lib/hadoop-core-1.2.0.jar
javac -d ./classes/ -cp ./src/:./lib/jsch-0.1.50.jar:./lib/hadoop-core-1.2.0.jar ./src/dcc/ufmg/anthill/*.java ./src/dcc/ufmg/anthill/info/*.java ./src/dcc/ufmg/anthill/net/*.java ./src/dcc/ufmg/anthill/stream/*.java ./src/dcc/ufmg/anthill/scheduler/*.java ./src/dcc/ufmg/anthill/util/*.java 
